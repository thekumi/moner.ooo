...
// Info Text
$info = "このサイトの為替レートは情報提供のみを目的としています。正確性は保証されず、予告なく変更されることがあります。為替レートは5秒ごとに更新されます。最後の更新: <u title='Hours:Minutes:Seconds (hh:mm:ss)'>".$time."</u> 時間, Europe/Berlin。 データ提供者: <a class='text-white' href='https://www.coingecko.com/ja/%E3%82%B3%E3%82%A4%E3%83%B3/%E3%83%A2%E3%83%8D%E3%83%AD' hreflang='ja' rel='external' target='_blank'>CoinGecko</a>。<br/><a target='_blank' href='https://kuno.anne.media/donate/onml/' rel='external' hreflang='en'><img loading='lazy' src='./img/kuno-monero-26x26.png' width='17' height='17' alt='Kuno - Moner.ooo donation page'></a>&nbsp;<a target='_blank' href='https://kuno.anne.media/' class='text-white' rel='external' hreflang='en'>Kuno – Moneroで資金を集める</a> | <a class='text-white' href='{$github_url}' hreflang='en' rel='external' target='_blank'>GitHub</a>";
$servers_guru = " | <a style='text-decoration:none; font-weight:bold;' class='text-white' href='https://servers.guru/' hreflang='en' rel='external' target='_blank'>Webホスティング提供者<img loading='lazy' src='./img/servers-guru.svg' height='19' alt='Servers Guru' title='Servers Guru' /></a>";
