...
// Info Text
$info = "Курсы обмена, представленные на этом сайте, носят исключительно информационный характер. Их точность не гарантируется, и они могут быть изменены без предварительного уведомления. Курсы обмена обновляются каждые 5 секунд. Последнее обновление <u title='Hours:Minutes:Seconds (hh:mm:ss)'>$time</u>, Europe/Berlin. Данные предоставлены <a class='text-white' href='https://www.coingecko.com/ru/%D0%9A%D1%80%D0%B8%D0%BF%D1%82%D0%BE%D0%B2%D0%B0%D0%BB%D1%8E%D1%82%D1%8B/%D0%9C%D0%BE%D0%BD%D0%B5%D1%80%D0%BE' hreflang='ru' rel='external' target='_blank'>CoinGecko</a>.<br/><a target='_blank' href='https://kuno.anne.media/donate/onml/' rel='external' hreflang='en'><img loading='lazy' src='./img/kuno-monero-26x26.png' width='17' height='17' alt='Kuno - Moner.ooo страница для донатов'></a>&nbsp;<a target='_blank' href='https://kuno.anne.media/donate/onml/' class='text-white' rel='external' hreflang='en'>Kuno – Сбор средств с помощью Monero</a> | <a class='text-white' href='https://github.com/nice42q/moner.ooo' hreflang='en' rel='external' target='_blank'>GitHub</a> | <a style='text-decoration:none; font-weight:bold;' class='text-white' href='https://servers.guru/' hreflang='en' rel='external' target='_blank'>Webhosting provided by<img loading='lazy' src='./img/servers-guru.svg' height='19' alt='Servers Guru' title='Servers Guru' /></a>";
